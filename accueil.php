    ...
    <div class="rangee2">
        ...
        <div class="competences__conteneur">
            <p class="competences__texte">
                ...
                projet, réalisation de projets d’envergure, stage crédité et stage en Alternance Travail-Études (ATE)
            </p>
        </div>
    </div>
</div>
...
<div class="grilleCours">
    <h2 class="titre__h2">As-tu le profil?</h2>
    <p class="grilleCours__texte">Afin d’obtenir plus de détails sur les différents cours, veuillez consulter la grille
...
<div class="inscrire">
    ...
    <p class="inscrire__texte">Les demandes d'admission au programme TIM sont reçues avant le 1er mars de chaque année
        (1er tour), 1er mai (2e tour), 1er juin (3e tour) et 1er août (4e tour). Pour compléter ta demande d'admission à
